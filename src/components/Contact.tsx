        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="relative h-full min-h-[400px] lg:min-h-[500px]">
            <div className="absolute inset-0 bg-gray-200 rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2895.4276460479286!2d6.1141143!3d49.317971500000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4795258664a86ccf%3A0x8db9ac174343560f!2sSnack%20Karadeniz%20Florange!5e1!3m2!1sfr!2sfr!4v1770064656172!5m2!1sfr!2sfr"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
